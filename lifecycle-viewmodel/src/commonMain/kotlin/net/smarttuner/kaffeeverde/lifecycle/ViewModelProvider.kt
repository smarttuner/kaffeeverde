 ...
 * https://android.googlesource.com/platform/frameworks/support/+/HEAD/lifecycle/lifecycle-viewmodel/src/main/java/androidx/lifecycle/ViewModelProvider.kt
 *
...
//        }.also { store.put(key, it) }
    ...
    open operator fun <T : ViewModel> set(modelClass: KClass<T>, viewModel: T) {
        val canonicalName = modelClass.simpleName
            ?: throw IllegalArgumentException("Local and anonymous classes can not be ViewModels")
        set("$DEFAULT_KEY:$canonicalName", viewModel)
    }
...
//                    if (NonAndroidViewModelFactory::class.java.isAssignableFrom(modelClass)) {
...
//        }
//        @Suppress("DocumentExceptions")
//        private fun <T : ViewModel> create(modelClass: KClass<T>, app: Application): T {
...
inline fun <reified VM : ViewModel> ViewModelProvider.get(): VM? = get(VM::class)
inline fun <reified VM : ViewModel> ViewModelProvider.set(viewModel: VM) = set(VM::class, viewModel)