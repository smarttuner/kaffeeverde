 ...
 * https://android.googlesource.com/platform/frameworks/support/+/HEAD/lifecycle/lifecycle-viewmodel/src/main/java/androidx/lifecycle/viewmodel/InitializerViewModelFactory.kt
 *
 * The content of this file is a port of the original work with some additions
 *
 */
package net.smarttuner.kaffeeverde.lifecycle.viewmodel


import net.smarttuner.kaffeeverde.lifecycle.ViewModel
import net.smarttuner.kaffeeverde.lifecycle.ViewModelProvider
...
public class InitializerViewModelFactoryBuilder {
    ...
    fun <T : ViewModel> addInitializer(clazz: KClass<T>, initializer: CreationExtras.() -> T) {
        initializers.add(ViewModelInitializer(clazz, initializer))
    }
    /**
...
internal class InitializerViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: KClass<T>, extras: CreationExtras): T {
        ...
        return viewModel ?: throw IllegalArgumentException(
            "No initializer set for given class ${modelClass.simpleName}"
        )
    }
}