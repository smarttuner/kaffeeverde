 ...
 * https://android.googlesource.com/platform/frameworks/support/+/HEAD/navigation/navigation-common/src/main/java/androidx/navigation/NavOptions.kt
 */
...
public class NavOptions internal constructor(
    ...
    @OptIn(ExperimentalSafeArgsApi::class, ExperimentalStdlibApi::class)
    override fun toString(): String {
        ...
        if (enterAnim != -1 || exitAnim != -1 || popEnterAnim != -1 || popExitAnim != -1) {
            ...
            sb.append(enterAnim.toHexString())
            sb.append(" exitAnim=0x")
            sb.append(exitAnim.toHexString())
            sb.append(" popEnterAnim=0x")
            sb.append(popEnterAnim.toHexString())
            sb.append(" popExitAnim=0x")
            sb.append(popExitAnim.toHexString())
            sb.append(")")
        }
        return sb.toString()
    }
    ...
    public class Builder {
         ...
         */
        public fun setEnterAnim(  enterAnim: Int): Builder {
         ...
         */
        public fun setExitAnim(  exitAnim: Int): Builder {
         ...
         */
        public fun setPopEnterAnim(  popEnterAnim: Int): Builder {
         ...
         */
        public fun setPopExitAnim(  popExitAnim: Int): Builder {
