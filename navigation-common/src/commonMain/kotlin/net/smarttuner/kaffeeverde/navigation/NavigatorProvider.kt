 ...
 * https://android.googlesource.com/platform/frameworks/support/+/HEAD/navigation/navigation-common/src/main/java/androidx/navigation/NavigatorProvider.kt
 */
...
public open class NavigatorProvider {
    ...
    public fun addNavigator(
        ...
        return addNavigator(name = getNameForNavigator(navigator::class), navigator = navigator)
    }
    /**
    ...
    internal companion object {
        private val annotationNames = mutableMapOf<KClass<*>, String?>()
